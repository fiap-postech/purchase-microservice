...
public enum ApplicationError implements BaseApplicationError {
    ...
    CUSTOMER_NOT_FOUND_BY_UUID("AE-004", INVALID_PARAMETER, TRUE, "Customer not found [uuid={}]"),
    PAYMENT_NOT_FOUND("AE-005", NOT_FOUND, TRUE, "There are no payment registered for purchase [purchaseUUID={}]"),
    PURCHASE_NOT_FOUND_BY_UUID("AE-006", NOT_FOUND, TRUE, "Purchase not found [uuid={}]"),
    ;
