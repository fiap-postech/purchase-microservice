...
import static br.com.fiap.tech.challenge.purchase.enterprise.enums.ProductCategory.BEVERAGE;
import static br.com.fiap.tech.challenge.purchase.enterprise.enums.ProductCategory.SANDWICH;
import static br.com.fiap.tech.challenge.purchase.enterprise.enums.ProductCategory.SIDE_DISH;
...
public class ProductInputDTOFixture {
    ...
    public static Model<SingleProductInputDTO> beverageInputDTO() {
        return Instancio.of(SingleProductInputDTO.class)
                ...
                .set(field(SingleProductInputDTO::getCategory), BEVERAGE)
                .toModel();
    }
    ...
    public static Model<SingleProductInputDTO> sideDishInputDTO() {
        return Instancio.of(SingleProductInputDTO.class)
                ...
                .set(field(SingleProductInputDTO::getDiscount), BigDecimal.ZERO)
                .set(field(SingleProductInputDTO::getCategory), SIDE_DISH)
                .toModel();
    }
    ...
    public static Model<SingleProductInputDTO> sandwichInputDTO() {
        return Instancio.of(SingleProductInputDTO.class)
                ...
                .set(field(SingleProductInputDTO::getDiscount), BigDecimal.ZERO)
                .set(field(SingleProductInputDTO::getCategory), SANDWICH)
                .toModel();
    }
